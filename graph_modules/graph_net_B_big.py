...
NO_GRAPH_FEATURES_ONE=128*bigger*2
NO_GRAPH_FEATURES_TWO=64*bigger*2

NO_NODE_FEATURES_TWO=NO_GRAPH_FEATURES_ONE

NO_EDGE_FEATURES_TWO=32*bigger

ENCODING_NODE_1=64*bigger
ENCODING_EDGE_1=32*bigger
ENCODING_EDGE_2=NO_EDGE_FEATURES_TWO

HIDDEN_NODE_ONE,HIDDEN_NODE_TWO=128*bigger,128*bigger
HIDDEN_EDGE_ONE,HIDDEN_EDGE_TWO=64*bigger,64*bigger
HIDDEN_GRAPH_ONE,HIDDEN_GRAPH_TWO=128*bigger,128*bigger
